...
lvcheckvar=`sqlplus -S purptapp/purptapp@PUMISPRD<<EOD
set head off
set trim on
set pagesize 0
set linesize 32767
...
for i in $(cat /home/ratan/BILLED/DATA/$lv_fold_bl/DIV_LIST_NEW.txt)
do
...
# sh /oubidata4/extracts-oubiprod/UNBILLED/billed_ftp_dr.sh 
mkdir /data/puftpreport/UNBILLED/CSV_BILLED/$lv_fold_bl
mkdir /data/puftpreport/UNBILLED/CSV_BILLED/$lv_fold_bl/PUVNL

cp -r /home/ratan/BILLED/DATA/$lv_fold_bl/PUVNL/*.* /data/puftpreport/UNBILLED/CSV_BILLED/$lv_fold_bl/PUVNL/.
