...
bash /home/ratan/BILLED/SCRIPTS/billed_discom.sh PUVNL &

sleep 200

echo 'started from cron' >> /home/ratan/BILLED/SCRIPTS/tt.log

bash /home/ratan/BILLED/SCRIPTS/billed_discom.sh PVVNL &

sleep 200

echo 'started from cron' >> /home/ratan/BILLED/SCRIPTS/tt.log

bash /home/ratan/BILLED/SCRIPTS/billed_discom.sh MVVNL &

sleep 200

echo 'started from cron' >> /home/ratan/BILLED/SCRIPTS/tt.log

bash /home/ratan/BILLED/SCRIPTS/billed_discom.sh DVVNL &
