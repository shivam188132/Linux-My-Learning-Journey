...
then
#       mystr='purptapp/purptapp@PUMISPRD'
	gzip /home/ratan/BILLED/DATA/$lv_fold_bl/BILLED_PUVNL_*
	sleep 50
        cd /home/ratan/BILLED/DATA/$lv_fold_bl/
...
then
	...
	gzip /home/ratan/BILLED/DATA/$lv_fold_bl/BILLED_PVVNL_*
	sleep 50
        cd /home/ratan/BILLED/DATA/$lv_fold_bl/
...
then
	...
	gzip /home/ratan/BILLED/DATA/$lv_fold_bl/BILLED_MVVNL_*
	sleep 50
        cd /home/ratan/BILLED/DATA/$lv_fold_bl/
        cd /home/ratan/BILLED/DATA/$lv_fold_bl/
...
then
	...
	gzip /home/ratan/BILLED/DATA/$lv_fold_bl/BILLED_DVVNL_*
	sleep 50
        cd /home/ratan/BILLED/DATA/$lv_fold_bl/
