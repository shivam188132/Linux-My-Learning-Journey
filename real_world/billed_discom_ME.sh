...
if [ $mydiscom == 'PUVNL' ]
then
        mystr='purptapp/purptapp@PUMISBTCH'
elif [ $mydiscom == 'PVVNL' ]
then
        mystr='pvrptapp/Pv#sjhdU65@PVMISBTCH'
elif [ $mydiscom == 'MVVNL' ]
then
        mystr='mvrptapp/MrrajhmU19@MVMISBTCH'
elif [ $mydiscom == 'DVVNL' ]
then
        mystr='dvrptapp/D1bdfhmK21@DVMISBTCH'
else
...
gzip /home/ratan/BILLED/DATA/$lv_fold_bl/BILLED_$mydiscom_*
